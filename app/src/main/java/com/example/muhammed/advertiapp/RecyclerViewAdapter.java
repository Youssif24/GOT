...
class RecyclerViewAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public RecyclerViewAdapter(Context c, ArrayList<AdsClass> adsArrayList) {
        this.c = c;
    ...
    public RecyclerViewAdapter(Context c, ArrayList<AdsClass> adsArrayList, String savedAdId) {
        this.c = c;
        this.adsArrayList = adsArrayList;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ads_list_item_recycler, parent, false);
