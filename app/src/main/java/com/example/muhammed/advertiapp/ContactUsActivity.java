...
public class ContactUsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView textView;
    String nameApp, textToBeColored, htmlText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PicassoClient.userImage(ContactUsActivity.this, image_pathUser, imageView);

        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intentNavigation = new Intent(ContactUsActivity.this, ProfileActivity.class);
...
//        htmlText = nameApp.replace(textToBeColored,"<font color='#73b025'>T</font>");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.addCategory:
                startActivity(new Intent(ContactUsActivity.this, AddCategoryActivity.class));
                return true;

            case R.id.addAds:
                startActivity(new Intent(ContactUsActivity.this, Add_Ad.class));
                return true;

            case R.id.viewAllCategory:
                startActivity(new Intent(ContactUsActivity.this, ViewAllCategories_Admin.class));
                return true;

            case R.id.viewAllAds:
                startActivity(new Intent(ContactUsActivity.this, ViewAllAds_Admin.class));
                return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Advertisements) {
            intentNavigation = new Intent(ContactUsActivity.this, HomeActivity.class);
            startActivity(intentNavigation);

        } else if (id == R.id.nav_categories) {
            intentNavigation = new Intent(ContactUsActivity.this, ViewParentCategories.class);
            startActivity(intentNavigation);
            ...
            if (isNetworkOnline()) {
                ...
                Intent intent = new Intent(ContactUsActivity.this, LogIn_SignUp_Main.class);
            ...
            Intent intent = new Intent(ContactUsActivity.this, SavedAdsActivity.class);
            startActivity(intent);
        }
