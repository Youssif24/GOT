...
public class ViewSomeAds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_some_ads);
        ...
        refreshLayout = (SwipeRefreshLayout) findViewById(R.id.viewSomeAdsRefresh);
        ...
        if (typeShow.equals(getString(R.string.topViews))) {
            ...
            String idUserCompany = intentGet.getExtras().getString("idUserCompany").toString();
            params1.put("idUserCompany", idUserCompany);
            params1.put("function", "getCompanyAds");
        }


        hashMap = new HashMap<>();

        intent = new Intent(ViewSomeAds.this, CommentActivity.class);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (isNetworkOnline()) {
                    ...
                    Toast.makeText(ViewSomeAds.this, getString(R.string.noConnection), Toast.LENGTH_LONG).show();
                }
    ...
    private void showAds() {
        ...
        showSavedAd();
        try {
            adapterRecycler = new RecyclerViewMoreAdapter(ViewSomeAds.this, adsArrayList, savedAdId);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.addCategory:
                startActivity(new Intent(ViewSomeAds.this, AddCategoryActivity.class));
                return true;

            case R.id.addAds:
                startActivity(new Intent(ViewSomeAds.this, Add_Ad.class));
                return true;

            case R.id.viewAllCategory:
                startActivity(new Intent(ViewSomeAds.this, ViewAllCategories_Admin.class));
                return true;

            case R.id.viewAllAds:
                startActivity(new Intent(ViewSomeAds.this, ViewAllAds_Admin.class));
                return true;
